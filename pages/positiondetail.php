...
if (strpos($_SERVER['REQUEST_URI'], "id")) {
    $positionId = str_replace($_SERVER["SCRIPT_NAME"] . "?id=", "", $_SERVER['REQUEST_URI']);
    $positionId = urldecode($positionId);
...
// queries
$sql_basic = "SELECT player.playerName FROM player WHERE player.position = ' $positionId'";
        ...
        <div>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    $query = "SELECT player.playerid, player.playerName, player.cardRating, player.position, player.workRates, player.strongFoot, club.clubname 
                        FROM player
                        INNER JOIN club ON player.playerid = club.playerid
                        WHERE player.position = ' $positionId'";
